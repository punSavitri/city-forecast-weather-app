...
function updateCityTemperature(response) {
  ...
  humidityElement.innerHTML = `Humidity:<strong style="color: rgb(0, 154, 255);">${humidity}%</strong>`;
  let windSpeed = response.data.wind.speed;
  windElement.innerHTML = `Wind:<strong style="color: rgb(0, 154, 255);">${windSpeed}km/h</strong>`;
